					...
					<div className="row justify-content-between">
						<div className="col-lg-7 mb-5 mb-lg-0">
							<div className="imgs-grid">
								<div className="grid grid-1"><img src="assets/images/img-grid-1.jpg" alt="Untree.co 1" /></div>
								<div className="grid grid-2"><img src="assets/images/img-grid-2.jpg" alt="Untree.co 2" /></div>
								<div className="grid grid-3"><img src="assets/images/img-grid-3.jpg" alt="Untree.co 3" /></div>
							</div>
						</div>
				...
				<div className="container">
					<div className="row">
						...
						<div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
							<div className="product-item-sm d-flex">
								<div className="thumbnail">
									<img src="assets/images/product-1.png" alt="Image 1" className="img-fluid" />
								</div>
								<div className="pt-3">
									<h3>Nordic Chair</h3>
						...
						<div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
							<div className="product-item-sm d-flex">
								<div className="thumbnail">
									<img src="assets/images/product-2.png" alt="Image 2" className="img-fluid" />
								</div>
								<div className="pt-3">
						...
						<div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
							<div className="product-item-sm d-flex">
								<div className="thumbnail">
									<img src="assets/images/product-3.png" alt="Image 3" className="img-fluid" />
								</div>
								<div className="pt-3">
