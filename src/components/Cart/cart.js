                  ...
                  <tbody>
                    <tr>
                      <td className="product-thumbnail">
                        <img src="assets/images/product-1.png" alt="product-1" className="img-fluid" />
                      </td>
                      ...
                      <td>
                        <div className="input-group mb-3 d-flex align-items-center quantity-container" style={{ maxWidth: "120px" }}>
                          ...
                          <div className="input-group-append">
                            <button className="btn btn-outline-black increase" type="button"><span>+</span></button>
                          </div>
                        </div>
                    ...
                    <tr>
                      <td className="product-thumbnail">
                        <img src="assets/images/product-2.png" alt="product-2" className="img-fluid" />
                      </td>
                      <td className="product-name">
            ...
            <div className="col-md-6 pl-5">
              <div className="row justify-content-end">
                <div className="col-md-7">
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <button className="btn btn-black btn-lg py-3 btn-block" onclick="./checkout">Proceed To Checkout</button>
                    </div>
                  </div>
                </div>
              </div>
